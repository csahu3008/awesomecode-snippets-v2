...
export function ContributorsPage({ onNavigate }: ContributorsPageProps) {
  ...
  const filteredContributors = allContributors.filter(contributor =>
    ...
    contributor.topLanguages.some(lang => 
              ...
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div className="flex items-center space-x-3 min-w-0 flex-1">
                    <div className="w-12 h-12 bg-primary text-primary-foreground rounded-full flex items-center justify-center text-lg font-medium flex-shrink-0">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <CardDescription className="text-xs sm:text-sm">
                        Member since {formatDate(contributor.joinDate)}
                      </CardDescription>
                    </div>
                  </div>
              ...
              <CardContent>
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div className="text-center p-3 bg-muted/50 rounded-lg">
                    <div className="flex items-center justify-center mb-1">
                      ...
                      <span className="font-medium text-sm">{contributor.snippets}</span>
                    </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {contributor.topLanguages.map((language) => (
                ...
                <div className="flex items-center text-xs text-muted-foreground">
                  <span className="mr-1">📈</span>
                  <span className="truncate">Last active {contributor.recentActivity}</span>
                </div>
              </CardContent>
            </Card>
          );
